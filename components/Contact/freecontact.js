        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              ...
              <span>You can also send us an email info@envirobyte.com</span>
            </div>
          </div>
        </div>
      </div>
                ...
                <div className="col-lg-12 col-md-12">
                  <div className="form-group">
                    <input
                      ...
                      name="email"
                      placeholder="Email"
                      className="custom-form-input w-full text-gray-800 focus:ring-blue-500 focus:border-blue-500 focus:outline-none dark:focus:ring-blue-500 dark:focus:border-blue-500 false"
                      required
                    />
                    <ValidationError
                      prefix="Email"
