      ...
      <div className="project-details-area pt-[10rem] pb-100 dark:bg-[#151719]">
        <div className="container">
          <div className="projects-details-desc">
            ...
            <h3 className="dark:text-[#D9E3EA] text-[#191919]">Climate Change Adaptation</h3>
            ...
            <p className="dark:text-[#9BA9B4]">
              ...
              organization and its context, which will lead to setting
              achievable goals that work for both your business and the
              environment together and can be maintained. In addition to
              developing climate change adaptation plans for your organizations,
              emergency preparedness and response plans can be enhanced to
              address anticipated climate change impacts. Also, we offer
              effective and detailed training on these actions for a smooth
              transition to a more climate-conscious business.
            </p>
            <h3 className="dark:text-[#D9E3EA] text-[#191919]">Climate Change Mitigation</h3>
            <p className="dark:text-[#9BA9B4]">
            ...
            <p className="dark:text-[#9BA9B4]">
              ...
              providing GHG quantification and reporting on behalf of clients,
              according to state-of-the-art, jurisdictional, and other
              requirements, such as ISO standards, government programmes such as
              the GHG Mitigation Assessment process that adheres to the Climate
            ...
            <p className="dark:text-[#9BA9B4]">
              ...
              and offset projects, as well as training on a broad range of
            ...
            <p className="dark:text-[#9BA9B4]">
              ...
              and Guidelines or ISO 14091:2021 Adaptation to Climate Change:
              Guidelines on Vulnerability, Impacts, and Risk Assessment.
              Additionally, we can help organizations with climate change
              resilience assessments that follow the guidelines for Climate Lens
              Assessments that Infrastructure Canada developed in 2019 and 2020.
              These risk and resilience assessments are the foundation for
            ...
            <p className="dark:text-[#9BA9B4]">
              ...
              provides a framework on how to disclose climate change information
              under the headings of Governance, Strategy, Risk Management, and
              Metrics and Targets. We specialize in the physical and
            ...
            <p className="dark:text-[#9BA9B4]">
              ...
              require all suppliers selling more than $7.5 million annually to
