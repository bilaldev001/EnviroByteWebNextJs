...
import NewsImage01 from '../../public/images/simple-home/news-01.jpg'
import NewsImage02 from '../../public/images/simple-home/news-02.jpg'
import NewsImage03 from '../../public/images/simple-home/news-03.jpg'
import NewsAuthor01 from '../../public/images/simple-home/news-author-01.jpg'
import NewsAuthor02 from '../../public/images/simple-home/news-author-02.jpg'
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="md:text-[42px] text-[32px] mb-4 text-[#191919] dark:text-[#D9E3EA] font-extrabold tracking-tighter">
              ...
              <article className="flex flex-col h-full" data-aos="zoom-y-out">
                <header>
                  ...
                  <h3 className="text-xl font-bold leading-snug tracking-tight ">
                    <a href="#0" className="hover:underline dark:text-[#D9E3EA] text-[#191919]">
                ...
                <footer className="text-sm flex items-center mt-4">
                  ...
                  <div>
                    ...
                    <a className="font-medium hover:underline dark:text-[#D9E3EA] text-[#191919]" href="#0">
                      Lisa Allison
                    </a>
                  </div>
                </footer>
